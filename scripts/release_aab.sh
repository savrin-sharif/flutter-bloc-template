...
output="build/app/releases/$label"; mkdir -p "$output"
cp build/app/outputs/bundle/release/app-release.aab "$output/app-release-$label.aab"
...
echo "AAB created at $output/app-release-$label.aab"
